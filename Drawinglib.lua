...
task.spawn(function()
    ...
    drawingUI = Instance.new("ScreenGui", game:GetService("CoreGui"))
...
function DrawingLib.new(drawingType)
    ...
    if drawingType == "Line" then
        ...
        lineFrame.Name = "Drawing_" .. drawingIndex
    ...
    elseif drawingType == "Text" then
        ...
        textLabel.Name = "Drawing_" .. drawingIndex
            ...
            __newindex = function(_, index, value)
                ...
                elseif index == "Center" then
                    if value then
                        ...
                        local offset = textLabel.TextBounds / 2
                        textLabel.Position = UDim2.fromOffset(textObj.Position.X + offset.X, textObj.Position.Y + offset.Y)
                    end
    ...
    elseif drawingType == "Circle" then
        ...
        circleFrame.Name = "Drawing_" .. drawingIndex
    ...
    elseif drawingType == "Square" then
        ...
        squareFrame.Name = "Drawing_" .. drawingIndex
    ...
    elseif drawingType == "Image" then
        ...
        imageFrame.Name = "Drawing_" .. drawingIndex
